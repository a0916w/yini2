...
const _dict = <String, Map<String, String>>{
  ...
  'cinemaSub2': {'zh': '今日上新 {n} 部 · 找剧不迷路', 'en': '{n} new today · never get lost', 'vi': '{n} phim mới hôm nay · tìm phim dễ dàng', 'th': 'ใหม่วันนี้ {n} เรื่อง · หาละครง่าย', 'id': '{n} baru hari ini · gampang cari'},
  'todayPick': {'zh': '今日主打', 'en': "Today's Pick", 'vi': 'Đề cử hôm nay', 'th': 'เด่นวันนี้', 'id': 'Unggulan Hari Ini'},
  'watchNow2': {'zh': '立即看', 'en': 'Watch', 'vi': 'Xem ngay', 'th': 'ดูเลย', 'id': 'Tonton'},
  'newSection': {'zh': '新剧首发', 'en': 'New Releases', 'vi': 'Phim mới ra mắt', 'th': 'เรื่องใหม่ล่าสุด', 'id': 'Rilisan Baru'},
  'dailyNew': {'zh': '每日上新', 'en': 'daily updates', 'vi': 'cập nhật mỗi ngày', 'th': 'อัปเดตทุกวัน', 'id': 'tiap hari'},
  'everyoneWatching': {'zh': '大家都在看', 'en': "Everyone's Watching", 'vi': 'Mọi người đang xem', 'th': 'ใครๆ ก็ดู', 'id': 'Semua Menonton'},
  'newBadge': {'zh': '新', 'en': 'NEW', 'vi': 'MỚI', 'th': 'ใหม่', 'id': 'BARU'},
  'allDramas': {'zh': '全部剧集', 'en': 'All Dramas', 'vi': 'Tất cả phim', 'th': 'ละครทั้งหมด', 'id': 'Semua Drama'},
  'playsLabel': {'zh': '播放', 'en': ' plays', 'vi': ' lượt xem', 'th': ' วิว', 'id': ' tayang'},
  'checkin': {'zh': '签到有礼', 'en': 'Check-in Gift', 'vi': 'Điểm danh nhận quà', 'th': 'เช็กอินรับของ', 'id': 'Absen Berhadiah'},
  'allLink': {'zh': '全部 ›', 'en': 'All ›', 'vi': 'Tất cả ›', 'th': 'ทั้งหมด ›', 'id': 'Semua ›'},
  'watchingN': {'zh': '{n}在看', 'en': '{n} watching', 'vi': '{n} đang xem', 'th': '{n} กำลังดู', 'id': '{n} menonton'},
  'heatN': {'zh': '热度 {n}', 'en': 'Heat {n}', 'vi': 'Độ hot {n}', 'th': 'ฮีต {n}', 'id': 'Panas {n}'},
  'swipeHint': {'zh': '上滑看下一部', 'en': 'Swipe up for next', 'vi': 'Vuốt lên xem tiếp', 'th': 'ปัดขึ้นดูเรื่องถัดไป', 'id': 'Geser ke atas'},
  'danmakuDemo2': {'zh': '前方高能', 'en': 'Epic moment ahead', 'vi': 'Cao trào phía trước', 'th': 'ฉากเด็ดกำลังมา', 'id': 'Momen seru di depan'},
  ...
  'redeemHint': {'zh': '输入兑换码', 'en': 'Enter redeem code', 'vi': 'Nhập mã đổi', 'th': 'กรอกโค้ดแลก', 'id': 'Masukkan kode'},
  'redeemOk': {'zh': '兑换成功', 'en': 'Redeemed!', 'vi': 'Đổi thành công!', 'th': 'แลกสำเร็จ!', 'id': 'Berhasil ditukar!'},
  'confirm': {'zh': '确定', 'en': 'Confirm', 'vi': 'Xác nhận', 'th': 'ยืนยัน', 'id': 'Konfirmasi'},
